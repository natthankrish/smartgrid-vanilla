export const setupHomePage = () => {
    ...
    const updateItemDisplay = () => {
      ...
      content += `<button class='button-2' id="see-more-button">See More</button>`
    ...
    const handleDropdownItemClick = (e) => {
      e.preventDefault();
      const navId = parseInt(e.target.dataset.nav, 10);
      currentNav = navId;
      dropdownMenuButton.textContent = e.target.textContent;
      updateItemDisplay();
    };
